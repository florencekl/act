...
SIM_TASK_CONFIGS = {
    ...
    'NMDID_v4.2': {
        'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2',
        'episode_start': 0,
        'num_episodes': 1.0,
        'episode_len': 200,
        'camera_names': ['ap', 'lateral', 'ap_cropped', 'lateral_cropped'],
        'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TRAIN',
        'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/VAL',
        'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TEST',
    },
    # 'NMDID_v4.2_ap_only': {
    #     'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2',
    #     'episode_start': 0,
    #     'num_episodes': 1.0,
    #     'episode_len': 200,
    #     'camera_names': ['ap', 'ap_cropped'],
    #     'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TRAIN',
    #     'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/VAL',
    #     'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TEST',
    # },
    # 'NMDID_v4.2_lateral_only': {
    #     'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2',
    #     'episode_start': 0,
    #     'num_episodes': 1.0,
    #     'episode_len': 200,
    #     'camera_names': ['lateral', 'lateral_cropped'],
    #     'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TRAIN',
    #     'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/VAL',
    #     'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2/TEST',
    # },
    'NMDID_v4.2_subset': {
        'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2_subset',
        'episode_start': 0,
        'num_episodes': 1.0,
        'episode_len': 200,
        'camera_names': ['ap', 'lateral', 'ap_cropped', 'lateral_cropped'],
        'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2_subset',
        'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2_subset',
        'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.2_subset',
    },
    'NMDID_v4.3': {
        'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.3',
        'episode_start': 0,
        'num_episodes': 1.0,
        'episode_len': 200,
        'camera_names': ['ap', 'lateral', 'ap_cropped', 'lateral_cropped'],
        'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.3/TRAIN',
        'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.3/VAL',
        'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.3/TEST',
    },
    'NMDID_v4.4': {
        'dataset_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.4_pointer',
        'episode_start': 0,
        'num_episodes': 1.0,
        'episode_len': 200,
        'camera_names': ['ap', 'lateral', 'ap_cropped', 'lateral_cropped'],
        'train_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.4_pointer/TRAIN',
        'val_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.4_pointer/VAL',
        'test_dir': ALT_DATA_DIR + '/NMDID_subclustering_v4.4_pointer/TEST',
    },
    'verse19': {
        'dataset_dir': ALT_DATA_DIR + '/verse19',
        'episode_start': 0,
        'num_episodes': 1.0,
        'episode_len': 200,
        'camera_names': ['ap', 'lateral', 'ap_cropped', 'lateral_cropped'],
        'train_dir': ALT_DATA_DIR + '/verse19/TRAIN',
